...
using use = useUsing("use")`,
  ...
  [SkillNames.FLUTTER]: {
    ...
    name: "flutter",
    label: "Flutter",
    shortDescription: "One codebase to rule them all, respectfully! 💙📱",
    color: "#02569B",
  ...
  [SkillNames.KOTLIN]: {
    ...
    name: "kotlin",
    label: "Kotlin",
    shortDescription: "Android dev but without the Java headaches, let's go! 🤖☕️",
    color: "#7F52FF",
  ...
  [SkillNames.REACT_NATIVE]: {
    ...
    name: "reactnative",
    label: "React Native",
    shortDescription: "React devs pretending they know mobile... wait, it actually works! ⚛️📱",
    color: "#61dafb",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg",
  },
  [SkillNames.SWIFT]: {
    ...
    name: "swift",
    label: "Swift",
    shortDescription: "Apple ecosystem locked and loaded! 🍏🍎",
    color: "#F05138",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Kart Builds Studio · Remote",
    description: [
      "Building scalable full stack web applications and cross-platform mobile apps with modern tech stacks.",
      "Developing and optimizing backend services and APIs for high performance and reliability.",
      "Implementing clean architecture and reusable components across web and mobile platforms.",
      "Collaborating on production-ready features from development to deployment.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
  ...
  },
  {
    ...
    company: "MSKARD Business Solution · Remote",
    description: [
      "Leading development of cross-platform mobile applications with a focus on performance and scalability.",
      "Designed and delivered production-ready apps with clean UI/UX and efficient state management.",
      "Managed app architecture, code quality, and deployment workflows.",
      "Collaborated with team members to ship features end-to-end across mobile platforms.",
    ],
    skills: [
      SkillNames.FLUTTER,
      SkillNames.FIREBASE,
  ...
  },
  {
    ...
    company: "MSKARD Business Solution · Remote",
    description: [
      "Developed and maintained web and mobile application features for client projects.",
      "Built responsive UI components and integrated backend APIs.",
      "Improved performance and optimized application workflows.",
      "Contributed to debugging, testing, and deploying applications.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
